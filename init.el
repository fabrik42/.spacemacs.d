...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(html
     ...
     ;; ----------------------------------------------------------------
     ;; (spacemacs :packages (not neotree))
     ...
     ;; deft
     (elixir :variables elixir-backend 'lsp elixir-ls-path "/Users/fabrik42/dev/system/elixir-ls")
     ...
     (ruby :variables
           ...
           ruby-backend 'robe ;; disable lsp for ruby for now
           )
     (rust :variables
           rust-backend 'lsp
           rust-format-on-save t
           )
     ;; semantic ;; elisp format
     (shell :variables
   ...
   dotspacemacs-excluded-packages '(
                                    ...
                                    coffee-mode       ;; js layer
                                    emmet-mode        ;; html, js and react layer
                                    skewer-mode       ;; js layer, hot module reloading in emacs
                                    livid-mode        ;; js layer, hot module reloading in emacs, too
                                    less-css-mode     ;; html layer
                                    pug-mode          ;; html layer

                                    rvm               ;; ruby layer
                                    chruby            ;; ruby layer
                                    minitest          ;; ruby layer
                                    enh-ruby-mode ;; ruby layer
                                    ruby-test-mode
...
It should only modify the values of Spacemacs settings."
  ;; Increase gc-cons-threshold to 2GB
  ...
  (setq-default
   ...
   ;; tries to make powerline icons work, see https://www.reddit.com/r/spacemacs/comments/4mkgkl/ugly_separator_borders_on_powerline/
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  (add-to-list 'custom-theme-load-path "~/.spacemacs.d/config/")
  )
...
you should place your code here."
  ...
  ;; fixes forge-pull problem in emacs 26.2
