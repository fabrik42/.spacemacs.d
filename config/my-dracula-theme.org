#+TITLE: My Dracula Theme
#+SETUPFILE: ./_setup.org

My favorite theme is [[https://draculatheme.com][Dracula]] which I use for a lot of different applications. Of course, there is also a [[https://github.com/dracula/emacs][port for Emacs]]. I use almost all of the given settings, but heavily customized the appearance of =Org mode=.

* Color Palette
The original color palette from the Dracula theme.

#+NAME: color-table
#+BEGIN_SRC emacs-lisp :noweb yes :exports results :tangle no :results value html

(let* (
       ;; include color palette
       <<color-palette>>
       (table-start "<table><thead><tr><th>Color</th><th>Name</th></tr></thead><tbody>")
       (table-end "</tbody></table>")
       (table-rows
        (mapconcat
         (lambda (x)
           (format
            "<tr><td style=\"background:%s;width:100px\"></td><td>%s</td></tr>"
            (cadr x)
            (car x)))
         colors
         "\n")))

  (format "%s\n%s\n%s" table-start table-rows table-end)
)
#+END_SRC

#+RESULTS: color-table
#+BEGIN_EXPORT html
<table><thead><tr><th>Color</th><th>Name</th></tr></thead><tbody>
<tr><td style="background:#f8f8f2;width:100px"></td><td>fg1</td></tr>
<tr><td style="background:#e2e2dc;width:100px"></td><td>fg2</td></tr>
<tr><td style="background:#ccccc7;width:100px"></td><td>fg3</td></tr>
<tr><td style="background:#b6b6b2;width:100px"></td><td>fg4</td></tr>
<tr><td style="background:#282a36;width:100px"></td><td>bg1</td></tr>
<tr><td style="background:#373844;width:100px"></td><td>bg2</td></tr>
<tr><td style="background:#464752;width:100px"></td><td>bg3</td></tr>
<tr><td style="background:#565761;width:100px"></td><td>bg4</td></tr>
<tr><td style="background:#44475a;width:100px"></td><td>bg5</td></tr>
<tr><td style="background:#b45bcf;width:100px"></td><td>bg6</td></tr>
<tr><td style="background:#0189cc;width:100px"></td><td>key2</td></tr>
<tr><td style="background:#ff79c6;width:100px"></td><td>key3</td></tr>
<tr><td style="background:#ffb86c;width:100px"></td><td>builtin</td></tr>
<tr><td style="background:#ff79c6;width:100px"></td><td>keyword</td></tr>
<tr><td style="background:#8be9fd;width:100px"></td><td>const</td></tr>
<tr><td style="background:#6272a4;width:100px"></td><td>comment</td></tr>
<tr><td style="background:#50fa7b;width:100px"></td><td>func</td></tr>
<tr><td style="background:#f1fa8c;width:100px"></td><td>str</td></tr>
<tr><td style="background:#bd93f9;width:100px"></td><td>type</td></tr>
<tr><td style="background:#f8f8f2;width:100px"></td><td>var</td></tr>
<tr><td style="background:#ffb86c;width:100px"></td><td>warning</td></tr>
<tr><td style="background:#f8f8f2;width:100px"></td><td>rainbow-1</td></tr>
<tr><td style="background:#8be9fd;width:100px"></td><td>rainbow-2</td></tr>
<tr><td style="background:#bd93f9;width:100px"></td><td>rainbow-3</td></tr>
<tr><td style="background:#ff79c6;width:100px"></td><td>rainbow-4</td></tr>
<tr><td style="background:#ffb86c;width:100px"></td><td>rainbow-5</td></tr>
<tr><td style="background:#50fa7b;width:100px"></td><td>rainbow-6</td></tr>
<tr><td style="background:#f1fa8c;width:100px"></td><td>rainbow-7</td></tr>
<tr><td style="background:#0189cc;width:100px"></td><td>rainbow-8</td></tr>
<tr><td style="background:#ff5555;width:100px"></td><td>rainbow-9</td></tr>
<tr><td style="background:#a0522d;width:100px"></td><td>rainbow-10</td></tr>
<tr><td style="background:#f1fa8c;width:100px"></td><td>eph-verbatim</td></tr>
<tr><td style="background:#ff79c6;width:100px"></td><td>eph-code</td></tr>
</tbody></table>
#+END_EXPORT
...
#+BEGIN_SRC emacs-lisp :tangle my-dracula-theme.el :noweb no-export :exports none
